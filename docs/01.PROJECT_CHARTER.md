...
**There are no neural networks, LLMs, or machine learning models making decisions here. The engine operates entirely on deterministic graph theory, structural heuristics, and strict mathematical thresholds.